...
class MetaDataEditor(tk.Frame):
    ...
    def create_misctab(self):
        ...
        miscFrame = ttk.Frame(self.misctab)
        miscFrame.grid(row=0, column=0, columnspan=1, padx=0, pady=0, sticky=E+W+N+S)
        ...
        self.miscFiles.bind("<<ListboxSelect>>", self._weaponLoadSelection)
        ...
        miscFrame.columnconfigure(2, weight=5)

        self.misctab.rowconfigure(0, weight=1)
        self.misctab.columnconfigure(0, weight=1)
